document.addEventListener("DOMContentLoaded", function () {
    ...
    let isButtonEnabled = false; // Track if the "Read More..." button is enabled
    ...
    galleryButtons.forEach((button, index) => {
        button.addEventListener("click", () => {
            showMedia(index);
            enableReadMoreButton(); // Enable the "Read More..." button when a top button is clicked
        });
    });
    ...
    function updateDescription() {
        ...
        if (typeof galleryText === "undefined") {
            ...
            disableReadMoreButton(); // Disable the "Read More..." button when there's no description
        } else {
    ...
    updateDescription();
    disableReadMoreButton(); // Disable the "Read More..." button on page load
});
